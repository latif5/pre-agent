                ...
                <div class="row m-t-50 pt-3">
                    <div class="col-lg-5 offset-lg-1">
                        ...
                        <div>
                            ...
                            <h4 class="question" data-wow-delay=".1s">What is Lorem Ipsum?
                                <table>
                                    <tr>
                                        <td valign="top"><input type="radio"></td>
                                        <td>Asset = Liability ± Equity b. Asset = Liability + Expense c. Liability = Asset + Equity d. Asset = Liability + Equity</td>
                                    </tr>
                                    <tr>
                                        <td valign="top"><input type="radio"></td>
                                        <td>Asset = Liability + Expense</td>
                                    </tr>
                                    <tr>
                                        <td valign="top"><input type="radio"></td>
                                        <td>Asset = Liability + Expense</td>
