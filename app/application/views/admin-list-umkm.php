                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">List UMKM</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <table id="list-umkm" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama UMKM</th>
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click','.change-status',function(event){
                    ...
                    // }
                    $.ajax({
                        url: '<?php echo base_url("List_umkm/change_status"); ?>',
                        type: 'POST',
                        data: { id: id, val: val },
                ...
                var table = $('#list-umkm').DataTable({
                  ...
                  //     // }
                  // },
                  "sAjaxSource": "<?php echo base_url('List_umkm/get_data'); ?>"
                });
